...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "wrong click ka beh?🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "sakit mo naman ya😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "yeyyyy thanks krus 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/axellemfaok?igsh=MXZ0M3JoNGoyMmRsaQ==">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
